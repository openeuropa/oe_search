...
/**
 * Europa Search backend for search_api.
 *
 * @SearchApiBackend(
 *   id = "oe_search",
...
class EuropaSearchBackend extends BackendPluginBase implements PluginFormInterface {
  ...
  /**
   * The Europa Search Service instance.
   *
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['token_api_endpoint'] = [
      ...
      '#description' => $this->t('Token is a unique key generated by the search team.'),
      '#required' => TRUE,
      '#default_value' => $this->config->get('token_api_endpoint'),
    ];
  ...
  public function submitConfigurationForm(array &$form, FormStateInterface $form_state) {
    $this->config
      ...
      ->set('token_api_endpoint', $form_state->getValue('token_api_endpoint'))
      ->save();
  }
  ...
  public function viewSettings() {
    ...
    $info[] = [
      ...
      'info' => $this->config->get('token_api_endpoint'),
    ];
  ...
  public function search(QueryInterface $query) {
    ...
    foreach ($results as $document) {
      ...
      $result_set->setExtraData('search_api_esb_response', $result_item);
    }

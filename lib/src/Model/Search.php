...
class Search {
   ...
   *
   * @var \OpenEuropa\EnterpriseSearchClient\Model\Document[]
   */
  protected $bestBets;
   ...
   * The query language.
   *
   * @var \OpenEuropa\EnterpriseSearchClient\Model\QueryLanguage
   */
   ...
   *
   * @return \OpenEuropa\EnterpriseSearchClient\Model\Document[]
   ...
   *
   * @param \OpenEuropa\EnterpriseSearchClient\Model\Document[] $bestBets
   *   The best bets documents.
   */
   ...
   *
   * @return \OpenEuropa\EnterpriseSearchClient\Model\QueryLanguage
   *   The query language.
   */
   ...
   *
   * @param \OpenEuropa\EnterpriseSearchClient\Model\QueryLanguage $queryLanguage
   *   The query language.
   */
   ...
   *
   * @param \OpenEuropa\EnterpriseSearchClient\Model\Document[] $results
   *   An array of documents.
   */
